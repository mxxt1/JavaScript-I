...
let carYears = inventory.sort().map(function(x){return x.car_year;});
...
let bmw = inventory.filter(function(x){return x.car_make == "BMW";});
console.log(bmw);
let audi = inventory.filter(function(x){return x.car_make == "Audi";});
